...
public class BookService {
	...
	public void addBook(BookDTO bookDTO) {
		...
		book.setRate(bookDTO.getRateAverage());
	...
	public BookDTO updateBook(Long id, BookDTO bookDTO) {
		...
		existingBook.setRate(bookDTO.getRateAverage());
		...
		return BookDTO.builder().bookId(updatedBook.getBookId()).title(updatedBook.getTitle())
				...
				.quantityValid(updatedBook.getQuantityValid()).rateAverage(updatedBook.getRate()).build();
	}
